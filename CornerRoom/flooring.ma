...
//Name: flooring.ma
//Last modified: Sat, Feb 22, 2025 04:03:04 PM
//Codeset: 1252
...
fileInfo "UUID" "3517950E-40E2-6B50-AE28-98AB8FF06655";
createNode transform -s -n "persp";
	rename -uid "5888A5C9-49E9-DD37-1BD3-1B8851022ADF";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -20.560175370643048 11.791398950176209 1.5852310297168044 ;
	setAttr ".r" -type "double3" -30.000000002516064 -6205.600000000004 -8.2914363206176775e-14 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 22.823627815609701;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -0.8525887086290509 0.37958504150267441 0.068814880161166381 ;
...
createNode transform -n "BookStack";
	...
	setAttr ".t" -type "double3" 0.1602632936160151 0 0 ;
	setAttr ".s" -type "double3" 1.1427137560564291 1.1427137560564291 1.1427137560564291 ;
...
createNode transform -n "Rug";
	...
	setAttr ".s" -type "double3" 1.1460419824639319 1.1460419824639319 1.1460419824639319 ;
...
createNode transform -n "LightEdge" -p "WallLight";
	...
	setAttr ".t" -type "double3" 0 0 0.0072641716244317145 ;
...
createNode transform -n "LightBulb" -p "WallLight";
	...
	setAttr ".t" -type "double3" 0 0 -0.03163367590869548 ;
...
createNode transform -n "Flashlight";
	...
	setAttr ".t" -type "double3" -0.25459457680223008 -0.16240987528751843 0.028695780722995314 ;
	setAttr ".r" -type "double3" -5.0254477558595223 18.325784301200464 0 ;
	setAttr ".s" -type "double3" 1.0255560901558292 1.0255560901558292 1.0255560901558292 ;
...
createNode mesh -n "FlashlightBodyShape" -p "FlashlightBody";
	...
	setAttr -k off ".v";
	setAttr -s 2 ".iog[0].og";
	setAttr ".iog[0].og[0].gcl" -type "componentList" 3 "f[40:200]" "f[212]" "f[220:659]";
	setAttr ".iog[0].og[1].gcl" -type "componentList" 3 "f[0:39]" "f[201:211]" "f[213:219]";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr -s 10 ".gtag";
...
createNode transform -n "Telescope";
	...
	setAttr ".t" -type "double3" -0.56617301939758413 0.57350407874621778 3.7173551333421035 ;
	setAttr ".r" -type "double3" 0 -7.6566629054805535 0 ;
	setAttr ".s" -type "double3" 1.2546340541392298 1.2546340541392298 1.2546340541392298 ;
	setAttr ".rp" -type "double3" 0.69800511538511056 -0.50081716811694532 -2.2089928440201283 ;
	setAttr ".rpt" -type "double3" 1.1102230246251565e-16 0 -1.5820678100908481e-15 ;
...
createNode nRigid -n "nRigidShape12" -p "nRigid12";
	...
	setAttr -k on ".lifespan" 1;
	setAttr ".lifespanPP0" -type "doubleArray" 0 ;
createNode transform -n "WasllRim";
	rename -uid "DCCA92A9-4A87-921B-D497-3695EE6ED4C7";
createNode transform -n "pCube42" -p "WasllRim";
	rename -uid "723DBAC6-4568-814B-7525-42BD2BC6AB22";
	setAttr ".t" -type "double3" 2.5 6.1181785423910613 -2.9231781959533647 ;
	setAttr ".s" -type "double3" 5.994791451445078 0.15364364332825511 0.15364364332825511 ;
	setAttr ".rp" -type "double3" 0.5 0.076821629270315675 -0.076821804046635397 ;
	setAttr ".sp" -type "double3" 0.5 0.49999874779191822 -0.49999988533533646 ;
	setAttr ".spt" -type "double3" 0 -0.42317711852159673 0.42317808128869233 ;
createNode mesh -n "pCubeShape42" -p "pCube42";
	rename -uid "667B747F-433B-B4EA-AE3B-C698C14628D1";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "pCube43" -p "WasllRim";
	rename -uid "3DC42D71-45F6-C86D-B49C-D88F86074203";
	setAttr ".t" -type "double3" 2.3463563769185956 6.1181785423910613 -2.9231781959533647 ;
	setAttr ".r" -type "double3" 0 90 0 ;
	setAttr ".s" -type "double3" 5.994791451445078 0.15364364332825511 0.15364364332825511 ;
	setAttr ".rp" -type "double3" 0.5 0.076821629270315675 0.076821819034769381 ;
	setAttr ".rpt" -type "double3" 0.15364362308140445 0 -0.15364362308140789 ;
	setAttr ".sp" -type "double3" 0.5 0.49999874779191822 0.49999998288667535 ;
	setAttr ".spt" -type "double3" 0 -0.42317711852159623 -0.42317816385191431 ;
createNode mesh -n "pCubeShape43" -p "pCube43";
	rename -uid "AD742903-4A01-1ABF-AE99-57935F7E6C36";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr -s 6 ".gtag";
...
createNode transform -n "camera1";
	rename -uid "46FD7737-4765-C37F-76C4-B3890B60EAC7";
	setAttr ".t" -type "double3" -9.1410377867842314 7.1602995464514487 12.042307672574676 ;
	setAttr ".r" -type "double3" -16.994575085108686 -38.400000000000645 0 ;
createNode camera -n "cameraShape1" -p "camera1";
	rename -uid "49683911-484D-73AE-4202-CE9DB6A21B26";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".cap" -type "double2" 1.41732 0.94488 ;
	setAttr ".ff" 0;
	setAttr ".coi" 22.498903182974104;
	setAttr ".ow" 30;
	setAttr ".imn" -type "string" "camera1";
	setAttr ".den" -type "string" "camera1_depth";
	setAttr ".man" -type "string" "camera1_mask";
createNode transform -n "aiSkyDomeLight1";
	rename -uid "6DC3DB9F-4CE3-6328-D071-9F8213A52E6B";
createNode aiSkyDomeLight -n "aiSkyDomeLightShape1" -p "aiSkyDomeLight1";
	rename -uid "96579DB8-4717-D402-54E9-7E8606F2C651";
	setAttr -k off ".v";
	setAttr ".intensity" 0.19230769574642181;
createNode transform -n "WallLight1";
	rename -uid "EF3B8857-42A1-B134-0EEF-6CB3BEA56802";
	setAttr ".t" -type "double3" -2.3087558567924109 5.2410380030912433 -2.1034254139922979 ;
	setAttr ".s" -type "double3" 3.9331976727563607 3.9331976727563607 3.9331976727563607 ;
	setAttr ".rp" -type "double3" -4.3667266166961944e-16 0 0 ;
	setAttr ".sp" -type "double3" -1.1102230246251568e-16 0 0 ;
	setAttr ".spt" -type "double3" -3.2565035920710379e-16 0 0 ;
createNode pointLight -n "WallLightShape1" -p "WallLight1";
	rename -uid "6803F26E-4F16-4B0B-57A4-51B6D47FFF62";
	setAttr -k off ".v";
	setAttr ".cl" -type "float3" 0.42900002 0.49488395 1 ;
	setAttr ".in" 6.7948718070983887;
	setAttr ".us" no;
createNode transform -n "FlashLight";
	...
	setAttr ".spt" -type "double3" 2.4651903288156624e-32 0 -1.2325951644078312e-32 ;
createNode spotLight -n "FlashLightShape" -p "FlashLight";
	rename -uid "CCA7103D-4C71-F53F-743C-BA8FCFE3C637";
	setAttr -k off ".v";
	setAttr ".in" 7.6923074722290039;
	setAttr ".ca" 70.385864097951952;
	setAttr ".pa" 10;
createNode transform -n "CeilingAreaLight";
	rename -uid "5D2B5D00-4076-A9D1-6CC0-DFB6AAA8CF42";
	setAttr ".t" -type "double3" 0 6.4762491316883679 0 ;
	setAttr ".r" -type "double3" -90 0 0 ;
	setAttr ".s" -type "double3" 2.6896529492150041 2.6896529492150041 2.6896529492150041 ;
createNode areaLight -n "CeilingAreaLightShape" -p "CeilingAreaLight";
	rename -uid "DB03183C-437F-94FB-9A97-E2868FAAB576";
	setAttr -k off ".v";
	setAttr ".in" 10;
createNode transform -n "FrontLight";
	rename -uid "2ED65DDB-45E7-1E21-FA9D-ADB9B195D253";
	setAttr ".t" -type "double3" 0 3.1927122815471214 3.1773305396108098 ;
	setAttr ".s" -type "double3" 2.9990862116435459 2.9990862116435459 2.9990862116435459 ;
	setAttr ".rp" -type "double3" 0 -6.6593091300049999e-16 -6.6593091300049999e-16 ;
	setAttr ".sp" -type "double3" 0 -2.2204460492503131e-16 -2.2204460492503131e-16 ;
	setAttr ".spt" -type "double3" 0 -4.4388630807546868e-16 -4.4388630807546868e-16 ;
createNode areaLight -n "FrontLightShape" -p "FrontLight";
	rename -uid "2287AAA6-4CBB-4B76-E3C5-F4901966ECE9";
	setAttr -k off ".v";
	setAttr ".in" 10;
createNode transform -n "FillLight";
	rename -uid "BE11FCA3-4441-9A08-7C04-85B6718084ED";
	setAttr ".t" -type "double3" -0.60490262070695311 1.6475105537908115 -1.0901302110532098 ;
	setAttr ".r" -type "double3" -10.367910643358567 -79.407091953763043 4.3254095599804791e-15 ;
	setAttr ".s" -type "double3" 1 1.5103201186707198 1.0000000000000002 ;
	setAttr ".rp" -type "double3" 0 8.8817841970012523e-16 0 ;
	setAttr ".rpt" -type "double3" 1.5711987625867249e-16 -1.4501805098575541e-17 -2.9384056967112261e-17 ;
	setAttr ".sp" -type "double3" 0 8.8817841970012523e-16 0 ;
createNode areaLight -n "FillLightShape" -p "FillLight";
	rename -uid "2227CA9B-4B1C-DEE1-03DF-5291E947EB4F";
	setAttr -k off ".v";
	setAttr ".cl" -type "float3" 0.42900002 0.49488395 1 ;
	setAttr ".in" 4.0476188659667969;
createNode transform -n "areaLight1";
	rename -uid "BF951712-4D2C-77AE-5762-2F9DFBB7D7A4";
	setAttr ".t" -type "double3" 0 2.7181900585904941 0.81831743584801131 ;
	setAttr ".r" -type "double3" -54.584766257842922 0 0 ;
	setAttr ".s" -type "double3" 2.8133647946005409 2.8133647946005409 2.8133647946005409 ;
createNode areaLight -n "areaLightShape1" -p "areaLight1";
	rename -uid "9986C517-43B3-5E3B-699F-5586DDBC83FC";
	setAttr -k off ".v";
	setAttr ".in" 10;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "10625F30-4172-B120-22C3-8A950296406C";
	setAttr -s 18 ".lnk";
	setAttr -s 18 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "B65CD37E-41ED-8525-F3A0-14955B4A6C2F";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "0860DDCF-4763-ED75-D744-208D47800E7B";
createNode displayLayerManager -n "layerManager";
	rename -uid "F6206A28-4480-D246-2435-679E11711ED9";
createNode displayLayer -n "defaultLayer";
	rename -uid "25F6D558-43A2-862E-B022-04B24AA0EA7F";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "6DFEBD85-4B0C-17EB-C6CF-FDB998A3705E";
...
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	...
	setAttr ".ARV_options" -type "string" "Test Resolution=100%;Camera=cameraShape1;Snapshots Folder=C:/Users/kylee/OneDrive/Documents/School/Modeling/GitRepoModel/ModelClass2024/CornerRoom/images/snapshots/flooring;Color Management.Gamma=1;Color Management.Exposure=0;Background.BG=BG Color;Background.Color=0 0 0;Background.Image=;Background.Scale=1  1;Background.Offset=0  0;Background.Apply Color Management=1;Foreground.Enable FG=0;Foreground.Image=;Foreground.Scale=1  1;Foreground.Offset=0  0;Foreground.Apply Color Management=1;";
...
createNode polyCube -n "polyCube7";
	rename -uid "CAA7890A-4CD7-6F0A-5F76-8CA342098E17";
	setAttr ".cuv" 4;
createNode aiPhysicalSky -n "aiPhysicalSky1";
	rename -uid "1752FA8F-4A79-97F9-0B02-FC93368310E2";
	setAttr ".elevation" 13.157895088195801;
	setAttr ".azimuth" 315.78945922851562;
	setAttr ".sun_size" 3.24210524559021;
	setAttr ".sun_tint" -type "float3" 0.08849401 0.40449706 0.602 ;
	setAttr ".intensity" 1.6052631139755249;
createNode lambert -n "NewBLueWall";
	rename -uid "60AAB045-424F-4A77-0CBC-81BB52CD91E5";
	setAttr ".c" -type "float3" 0.0228 0.1129 0.1293 ;
createNode shadingEngine -n "lambert10SG";
	rename -uid "4E7B86BA-40E7-9A7E-FAC3-DBAF391D1111";
	setAttr ".ihi" 0;
	setAttr -s 2 ".dsm";
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo15";
	rename -uid "1C8CFE4F-401F-4D33-6EC0-DBBB163ADAAC";
createNode aiStandardSurface -n "aiStandardSurface1";
	rename -uid "B5983C52-4AD0-7174-A600-3CB7E82B95A7";
	setAttr ".emission" 0.54545456171035767;
createNode shadingEngine -n "aiStandardSurface1SG";
	rename -uid "83344606-493F-F313-93CD-B6A8D18B080D";
	setAttr ".ihi" 0;
	setAttr -s 2 ".dsm";
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo16";
	rename -uid "CB3ACD9B-4A8E-BE1A-8AD8-21B3DF166ECB";
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "33A06FBC-4935-A7B7-9B3D-3CBF2FBB0D4C";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -73.809520876596963 -314.42529302629964 ;
	setAttr ".tgi[0].vh" -type "double2" 438.06888271912885 284.07868656254891 ;
	...
	setAttr ".tgi[0].ni[4].y" 331.42855834960938;
	setAttr ".tgi[0].ni[4].nvs" 1923;
	setAttr ".tgi[0].ni[5].x" 184.28572082519531;
	setAttr ".tgi[0].ni[5].y" 330;
	setAttr ".tgi[0].ni[5].nvs" 1923;
createNode groupId -n "groupId41";
	rename -uid "FE41B19A-4E82-ABC2-54C3-C982D0D62C21";
	setAttr ".ihi" 0;
createNode groupId -n "groupId42";
	rename -uid "19430C6C-4353-A0BD-9D4B-0DB4E43F5E42";
	setAttr ".ihi" 0;
createNode groupId -n "groupId43";
	rename -uid "37E82520-4749-E4D8-3326-AC9FA25667B6";
	setAttr ".ihi" 0;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -av -k on ".ihi";
...
connectAttr "groupId41.id" "FlashlightBodyShape.iog.og[0].gid";
connectAttr "standardSurface2SG.mwc" "FlashlightBodyShape.iog.og[0].gco";
connectAttr "groupId43.id" "FlashlightBodyShape.iog.og[1].gid";
connectAttr "aiStandardSurface1SG.mwc" "FlashlightBodyShape.iog.og[1].gco";
connectAttr "groupId42.id" "FlashlightBodyShape.ciog.cog[0].cgid";
...
connectAttr "polyCube7.out" "pCubeShape42.i";
...
connectAttr "FlashlightBodyShape.iog.og[0]" "standardSurface2SG.dsm" -na;
connectAttr "FlashlightBodyShape.ciog.cog[0]" "standardSurface2SG.dsm" -na;
connectAttr "groupId41.msg" "standardSurface2SG.gn" -na;
connectAttr "groupId42.msg" "standardSurface2SG.gn" -na;
...
connectAttr "NewBLueWall.oc" "lambert10SG.ss";
connectAttr "ArchWallShape.iog" "lambert10SG.dsm" -na;
connectAttr "LivingRoomShape.iog" "lambert10SG.dsm" -na;
connectAttr "lambert10SG.msg" "materialInfo15.sg";
connectAttr "NewBLueWall.msg" "materialInfo15.m";
connectAttr "aiStandardSurface1.out" "aiStandardSurface1SG.ss";
connectAttr "LightBulbShape.iog" "aiStandardSurface1SG.dsm" -na;
connectAttr "FlashlightBodyShape.iog.og[1]" "aiStandardSurface1SG.dsm" -na;
...
connectAttr "aiStandardSurface1SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[1].dn"
		;
connectAttr "Cream.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
...
connectAttr "NewBLueWall.msg" ":defaultShaderList1.s" -na;
connectAttr "aiStandardSurface1.msg" ":defaultShaderList1.s" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
connectAttr "aiSkyDomeLightShape1.ltd" ":lightList1.l" -na;
connectAttr "WallLightShape1.ltd" ":lightList1.l" -na;
...
connectAttr "WallLight1.iog" ":defaultLightSet.dsm" -na;
