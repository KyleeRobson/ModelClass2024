...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 23.486938821116837;
...
createNode transform -n "camera1";
	...
	setAttr ".t" -type "double3" -11.515628163167792 6.0075124342439006 15.440202694079487 ;
	setAttr ".r" -type "double3" -9.0000000000002665 -38.400000000000645 0 ;
...
createNode areaLight -n "FrontLightShape" -p "FrontLight";
	...
	setAttr -k off ".v";
	setAttr ".in" 2.202380895614624;
createNode transform -n "FillLight";
	rename -uid "BE11FCA3-4441-9A08-7C04-85B6718084ED";
	setAttr ".t" -type "double3" -0.68385723730794945 2.2225711913135484 -0.79576323490873258 ;
