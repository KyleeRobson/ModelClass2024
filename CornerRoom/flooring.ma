...
//Name: flooring.ma
//Last modified: Wed, Sep 18, 2024 11:26:47 AM
//Codeset: 1252
...
fileInfo "UUID" "74DCD1BF-43E3-7CA8-0429-22A863CD8324";
createNode transform -s -n "persp";
	rename -uid "5888A5C9-49E9-DD37-1BD3-1B8851022ADF";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -8.5243788077264497 13.398207501983318 13.285160600356289 ;
	setAttr ".r" -type "double3" -35.999999999912767 -5791.2000000022645 -1.8591814211075533e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 23.004124932126285;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 1.1164809666132005 -0.12327787498353959 -2.6337909952998473 ;
...
createNode transform -n "Telescope";
	...
	setAttr ".r" -type "double3" 0 -11.51553624261817 0 ;
...
createNode mesh -n "TeleLegShape3" -p "TeleLeg3";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 5 ".pt";
	setAttr ".pt[8]" -type "float3" -0.29374832 0 -0.094886288 ;
	setAttr ".pt[9]" -type "float3" -0.29374832 0 -0.094886288 ;
	setAttr ".pt[10]" -type "float3" -0.29374832 0 -0.094886288 ;
	setAttr ".pt[11]" -type "float3" -0.29374832 0 -0.094886288 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "7D69D5DD-469A-E291-00BA-B6AF83702DEB";
	setAttr -s 16 ".lnk";
	setAttr -s 16 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "952667AA-41D9-5953-D2AA-81B84276D944";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "435BCEA4-4E03-6E86-2522-3BAED379A619";
createNode displayLayerManager -n "layerManager";
	rename -uid "BEDA8717-46A2-8E56-7303-9A82CFE3034B";
createNode displayLayer -n "defaultLayer";
	rename -uid "25F6D558-43A2-862E-B022-04B24AA0EA7F";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "B099A6A7-426A-F1EE-C118-8C976D530F3E";
