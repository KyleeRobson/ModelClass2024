...
//Name: flooring.ma
//Last modified: Tue, Sep 24, 2024 05:06:49 PM
//Codeset: 1252
...
fileInfo "UUID" "3D6A1824-4246-1E97-957B-D388B1A0FA78";
createNode transform -s -n "persp";
	rename -uid "5888A5C9-49E9-DD37-1BD3-1B8851022ADF";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -9.9350935273710554 5.3228379580660619 16.108788868119493 ;
	setAttr ".r" -type "double3" -4.2000000000012374 -6142.000000000502 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 22.358923667645122;
